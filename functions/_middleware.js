...
export async function onRequest(context) {
  ...
  const publicPaths = new Set(["/login", "/login.html", "/icon-192.png", "/icon-512.png", "/app-icon-192-v2.png", "/app-icon-512-v2.png", "/app-icon-192-moss-v3.png", "/app-icon-512-moss-v3.png", "/favicon-48.png", "/favicon-moss-v3.png", "/logo-full.jpg", "/logo-full-moss-v3.jpg", "/manifest.webmanifest", "/sw.js"]);
